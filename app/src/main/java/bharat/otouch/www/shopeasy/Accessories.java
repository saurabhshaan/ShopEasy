...
public class Accessories extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Accessories.AsyncFetch().execute();
    }
    ...
    class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(Accessories.this);
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL("http://192.168.43.147/shopeasy/accessoriesjson.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.d("TAG","recycle!!");
                mAdapter = new Adapter(Accessories.this,data);
                recyclerView.setAdapter(mAdapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(Accessories.this));
                Log.d("TAG","DATAPASS");

            } catch (JSONException e) {
                Toast.makeText(Accessories.this, e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
}