...
public class ComputerAccessories extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_accessories);
        ...
        new ComputerAccessories.AsyncFetch().execute();
    ...
    class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(ComputerAccessories.this);
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL("http://192.168.43.147/shopeasy/computeraccessoriesjson.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.d("TAG","recycle!!");
                mAdapter = new Adapter(ComputerAccessories.this,data);
                recyclerView.setAdapter(mAdapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(ComputerAccessories.this));
                Log.d("TAG","DATAPASS");

            } catch (JSONException e) {
                Toast.makeText(ComputerAccessories.this, e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
