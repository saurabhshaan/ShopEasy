...
public class HomeAppliences extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_appliences);
        ...
        new HomeAppliences.AsyncFetch().execute();
    ...
    class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(HomeAppliences.this);
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL("http://192.168.43.147/shopeasy/homeappliencesjson.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.d("TAG","recycle!!");
                mAdapter = new Adapter(HomeAppliences.this,data);
                recyclerView.setAdapter(mAdapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(HomeAppliences.this));
                Log.d("TAG","DATAPASS");

            } catch (JSONException e) {
                Toast.makeText(HomeAppliences.this, e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
