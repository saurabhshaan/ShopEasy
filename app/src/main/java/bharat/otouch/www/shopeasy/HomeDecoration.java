...
public class HomeDecoration extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new HomeDecoration.AsyncFetch().execute();
    ...
    class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(HomeDecoration.this);
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL("http://192.168.43.147/shopeasy/homedecorationjson.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.d("TAG","recycle!!");
                mAdapter = new Adapter(HomeDecoration.this,data);
                recyclerView.setAdapter(mAdapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(HomeDecoration.this));
                Log.d("TAG","DATAPASS");

            } catch (JSONException e) {
                Toast.makeText(HomeDecoration.this, e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
