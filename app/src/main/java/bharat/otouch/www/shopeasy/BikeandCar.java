...
public class BikeandCar extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bikeand_car);
        ...
        new BikeandCar.AsyncFetch().execute();
    ...
    class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(BikeandCar.this);
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL("http://192.168.43.147/shopeasy/bikeandcarjson.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.d("TAG","recycle!!");
                mAdapter = new Adapter(BikeandCar.this,data);
                recyclerView.setAdapter(mAdapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(BikeandCar.this));
                Log.d("TAG","DATAPASS");

            } catch (JSONException e) {
                Toast.makeText(BikeandCar.this, e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
