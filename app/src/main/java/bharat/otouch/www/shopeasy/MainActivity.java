...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new MainActivity.Phone().execute();
        new MainActivity.MensFashion().execute();
        new MainActivity.WomenF().execute();
        new MainActivity.Access().execute();
        new MainActivity.HomeA().execute();
    }
    ...
    class MensFashion extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL("http://192.168.43.147/shopeasy/mensfashionjson.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                recyclerView = (RecyclerView) findViewById(R.id.rev1);
                Log.d("TAG","recycle!!");
    ...
    class Phone extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                Log.d("URL","Url open");
                url = new URL("http://172.28.172.2/shopeasy/phonejson.php");
                Log.d("URL","Url close");
            } catch (MalformedURLException e) {
                e.printStackTrace();
                return e.toString();
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i=0; i<jarray.length();i++){
                    JSONObject jobject = jarray.getJSONObject(i);
                    AccessoriesData accessdata = new AccessoriesData();
                    Log.d("sec","Name"+jobject.getString("Product Name"));
                    Log.d("sec","Company"+jobject.getString("Product Company"));
                    Log.d("sec","warrenty"+jobject.getString("Product warrenty"));
                    Log.d("sec","Price"+jobject.getString("Product Price"));
                    Log.d("sec","Description"+jobject.getString("Product Description"));
                    Log.d("sec","Image"+jobject.getString("Product Image"));
    ...
    class HomeA extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(MainActivity.this);
        HttpURLConnection connection;
        URL url = null;
    ...
    class WomenF extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(MainActivity.this);
        HttpURLConnection connection;
        URL url = null;
    ...
    class Access extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(MainActivity.this);
        HttpURLConnection connection;
        URL url = null;
