...
public class MensFashion extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new MensFashion.AsyncFetch().execute();
    ...
    class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(MensFashion.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.d("TAG","recycle!!");
                mAdapter = new Adapter(MensFashion.this,data);
                recyclerView.setAdapter(mAdapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(MensFashion.this));
                Log.d("TAG","DATAPASS");

            } catch (JSONException e) {
                Toast.makeText(MensFashion.this, e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
