...
public class PhoneAccessories extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new PhoneAccessories.AsyncFetch().execute();
    ...
    class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(PhoneAccessories.this);
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL("http://192.168.43.147/shopeasy/phoneaccessoriesjson.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.d("TAG","recycle!!");
                mAdapter = new Adapter(PhoneAccessories.this,data);
                recyclerView.setAdapter(mAdapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(PhoneAccessories.this));
                Log.d("TAG","DATAPASS");

            } catch (JSONException e) {
                Toast.makeText(PhoneAccessories.this, e.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    }
